...
package top.wefor.now.swipeback;
...
public class SwipeBackLayout extends FrameLayout {
     ...
     * callback's
     * {@link top.wefor.now.swipeback.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link top.wefor.now.swipeback.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
